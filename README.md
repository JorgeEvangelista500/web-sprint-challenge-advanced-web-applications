...
A token is used the restrict access to certain users by working like a key and lock system, the token been the key

2. What steps can you take in your web apps to keep your data secure?
implementing token and private routes are good ways to keep you data safe,

3. Describe how web servers work.
a web server is a computer that stores data and the programs to execute when you do request from your client


4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

when interacting with api/servers we can use Post, Get, Put and Delete,
Post to send data, put to update, get to get data, delete to remove data.